...
// 请填写您的AccessKeyId。
var accessKeyId string = "LTAI5tF8YQeb8Xda6XgnoKsB"
// 请填写您的AccessKeySecret。
var accessKeySecret string = "Qprq0Twr0A4foXItRVxsvVnihUHlrD"
// host的格式为 bucketname.endpoint ，请替换为您的真实信息。
var host string = "http://zcshopfile.oss-cn-beijing.aliyuncs.com"
